...
Description:
  ...
  Variables are:
    ...
    If multiple $locations, specify by placing the 'lat,longs' into an array, like so:
    ...
    if(is_array($location) ) :
      ...
      foreach( $location as $coordinate ) :
        ...
        echo "var mapOptions_".$i." = {
          zoom: " . $zoom . ",";
          if( $styles == 'yes' ) :
            echo "disableDefaultUI: true, styles: styles,";
          endif;
      ...
      echo "var jewelMarker = new google.maps.Marker({
        position: myLatLng,
        map: map";
        if( $marker_url != '' ) :
          echo ", icon: image";
